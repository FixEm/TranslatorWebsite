...
import { Calendar, User, Phone, Mail, MessageSquare, Clock, CheckCircle, XCircle, AlertTriangle } from 'lucide-react';
...
export default function StudentBookingsManagement({ userId, providerName }: StudentBookingsManagementProps) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: `Booking ${status === 'confirmed' ? 'confirmed' : status === 'cancelled' ? 'cancelled' : 'updated'} successfully.`,
        });
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'pending':
        return <Badge variant="outline" className="bg-yellow-50 text-yellow-700 border-yellow-200">Menunggu Konfirmasi</Badge>;
      case 'confirmed':
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Lihat dan kelola permintaan booking dari klien</p>
        </div>
      ...
      {bookings.length > 0 ? (
              ...
              <CardContent className="p-6">
                  ...
                  <div className="flex-1">
                    ...
                    {booking.message && (
                      <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                        <h4 className="text-sm font-medium text-gray-700 mb-1">Pesan dari klien:</h4>
                ...
                {booking.adminNotes && (
                  <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <h4 className="text-sm font-medium text-blue-800 mb-1">Catatan:</h4>
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold text-gray-600 mb-2">Belum Ada Booking</h3>
          <p className="text-gray-500">
            Booking dari klien akan muncul di sini setelah mereka memilih tanggal yang tersedia.
          </p>
        </div>
      )}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-medium text-navy-600">{formatCurrency(selectedBooking.pricePerDay)}</p>
                </div>
                <div>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1 text-sm">
                  <p><span className="font-medium">Nama:</span> {selectedBooking.clientName}</p>
                  <p><span className="font-medium">Email:</span> {selectedBooking.clientEmail}</p>
                  <p><span className="font-medium">WhatsApp:</span> {selectedBooking.clientPhone}</p>
                </div>
              </div>
              ...
              {selectedBooking.message && (
                <div className="space-y-2">
                  <h4 className="font-medium text-gray-700">Pesan dari Klien</h4>
              ...
              <div className="flex gap-3 pt-4">
                {selectedBooking.status === 'pending' && (
                  <>
                    <Button
                      onClick={() => updateBookingStatus(selectedBooking.id, 'confirmed', responseMessage)}
                      disabled={isUpdating}
                      className="flex-1"
                    >
                      {isUpdating ? (
                    ...
                    <Button
                      variant="destructive"
                      onClick={() => updateBookingStatus(selectedBooking.id, 'cancelled', responseMessage)}
                      disabled={isUpdating}
                      className="flex-1"
                    >
                      <XCircle className="h-4 w-4 mr-2" />
                ...
                {selectedBooking.status === 'confirmed' && (
                  <Button
                    onClick={() => updateBookingStatus(selectedBooking.id, 'completed', responseMessage)}
                    disabled={isUpdating}
                    className="flex-1"
                  >
                    Tandai Selesai
