	...
	const roles = [
		{
			...
			features: ["Terjemahan dokumen", "Penerjemahan percakapan atau bisnis"],
			requirements: [
		...
		},
		{
			...
			icon: MapPin,
			description:
				"Memandu wisatawan dan berbagi pengetahuan tentang budaya lokal",
			features: ["Panduan wisata kota", "Tur budaya dan sejarah"],
			requirements: [
