		...
		<div className="min-h-screen bg-gray-50 flex">
			...
			>
				...
				<nav className="flex-1 py-6 flex flex-col items-center">
					{SIDEBAR_ITEMS.map((item) => (
						<button
							key={item.key}
							className={`w-full flex items-center gap-3 px-4 py-3 mb-2 font-medium transition-all duration-400 text-left whitespace-nowrap ${
								activeTab === item.key
			...
			<main className="flex-1 px-4 sm:px-8 py-8">
				...
				{activeTab === "verified-users" && (
					<div className="w-full space-y-6 overflow-hidden">
						...
						<div className="w-auto space-y-6">
							<div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-auto">
								<Card>
									<CardContent className="p-6">
										<div className="flex items-center">
											<div className="p-2 bg-green-100 rounded-lg">
									...
									{verifiedUsers.length === 0 ? (
										<div className="py-12 text-center">
											...
											<p className="text-gray-500">
												Users will appear here after final approval in
												recruitment
											</p>
										</div>
									) : (
				...
				{activeTab === "job-management" && (
					<>
						<h1 className="text-3xl font-bold text-navy-800">Job Management</h1>
