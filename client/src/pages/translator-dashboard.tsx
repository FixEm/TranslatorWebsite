		...
		<div className="space-y-6">
			...
			<div className="flex flex-col sm:flex-row gap-4">
				<div className="relative flex-1">
					...
					<Input
						placeholder="Cari jasa translator sesuai kebutuhan Anda..."
						value={searchQuery}
				...
				<div className="max-w-2xl mx-auto">
					<div className="mb-6">
						...
						<p className="text-gray-600">
							...
							atau{" "}
							<span className="font-semibold text-green-700">Individu</span>.
						</p>
						<div className="mt-4 text-sm text-gray-500">
							<p>
								<span className="font-bold text-blue-700">Travel Agency:</span>{" "}
								Untuk perusahaan travel, biro perjalanan, atau organisasi yang
								ingin mencari jasa translator untuk klien Anda.
							</p>
							<p className="mt-2">
								<span className="font-bold text-green-700">Individu:</span>{" "}
								Untuk perorangan yang ingin mencari jasa translator untuk
								kebutuhan pribadi, perjalanan, studi, atau bisnis Anda sendiri.
							</p>
						</div>
					</div>
					...
					<div className="flex flex-col sm:flex-row gap-3 justify-center">
						<Button className="bg-blue-600 hover:bg-blue-700 text-white px-6">
							Saya adalah Travel Agency
						</Button>
						<Button className="bg-green-600 hover:bg-green-700 text-white px-6">
							Saya adalah Individu
						</Button>
					</div>
				</div>
			</div>
				...
				return (
					<div className="text-center py-12">
						...
						<p className="text-gray-500">
							Percakapan dengan klien akan muncul di sini.
						</p>
					</div>
				);
			case "notifications":
