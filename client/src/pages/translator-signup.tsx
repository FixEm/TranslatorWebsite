...
export default function TranslatorSignup() {
	...
	const handleRoleSelect = (role: "translator" | "tour_guide") => {
		...
		setCurrentStep(2); // Now step 2 is questionnaire
	};
	...
	// Step 0: Landing Page with two options
	if (currentStep === 0) {
		return (
					...
					<div className="max-w-2xl mx-auto">
						<div className="mb-8">
							...
							<div className="text-center">
								<h1 className="text-3xl font-bold text-navy-800 mb-2 mt-6">
									Selamat Datang di AyoCabut
								</h1>
								<p className="text-gray-600">
									Pilih tujuan Anda untuk melanjutkan proses pendaftaran atau
									pencarian jasa penerjemah.
								</p>
							</div>
						</div>
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 mb-12">
							<Card className="hover:shadow-lg transition-shadow py-2">
								<CardHeader className="text-left">
									<div className="flex items-center mb-4">
										<span className="bg-blue-100 p-2 rounded-full mr-3">
											{/* Translator icon, smaller */}
											<svg
										...
										<CardTitle className="text-xl font-bold text-navy-800">
											Menjadi Penerjemah di AyoCabut
										</CardTitle>
									</div>
									<CardDescription className="text-gray-600 pb-2">
										Daftar sebagai penerjemah untuk membantu wisatawan di China.
									</CardDescription>
								...
								<CardFooter className="flex justify-start mt-8">
									<Button
										variant="default"
										className="w-full"
							...
							<Card className="hover:shadow-lg transition-shadow py-2">
								<CardHeader className="text-left">
									<div className="flex items-center mb-4">
										...
										<CardTitle className="text-xl font-bold text-navy-800">
											Mencari Jasa Translator di China
										</CardTitle>
									</div>
									<CardDescription className="text-gray-600 pb-2">
										Temukan penerjemah untuk membantu Anda dalam perjalanan atau
										bisnis.
									</CardDescription>
									<ul className="mt-6 space-y-3">
										<li className="flex items-center text-gray-700">
								...
								<CardFooter className="flex justify-start mt-8">
									...
									>
										Daftar Mencari Jasa Translator
									</Button>
								</CardFooter>
							</Card>
						</div>
							...
							<CardContent className="space-y-4">
								...
								<div className="grid grid-cols-2 gap-4">
									...
									<div>
										...
										<Select
											...
											onValueChange={(value) =>
												setApplication((prev) => ({ ...prev, city: value }))
											}
										>
											<SelectTrigger>
								...
								<div className="grid grid-cols-2 gap-4">
									...
									<div>
										...
										<Select
											value={application.expectedGraduation}
											onValueChange={(value) =>
												setApplication((prev) => ({
													...prev,
								...
								<div>
									<Label htmlFor="motivation">
										Mengapa Anda ingin bergabung dengan AyoCabut? *
									</Label>
									<Textarea
										id="motivation"
	...
	// Step 5: Travel Agency or Individual selection
	if (currentStep === 5) {
		return (
			<div className="min-h-screen bg-gray-50">
				<Header />
